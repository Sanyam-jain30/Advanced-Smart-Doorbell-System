...
class _MyHomePageState extends State<MyHomePage>{
  ...
  Future<void> loadNames() async {
    try {
      // Read the JSON file
      String jsonString = await rootBundle.loadString('backend/detected.json');
      log(jsonString);
      ...
      List<dynamic> namesList = data['names'];

      setState(() {
        // Update the state with the list of names
        names = namesList.cast<String>();
      });
    } catch (e) {
      log('Failed to load names: $e');
    }
  }
        ...
        child: Column(
          ...
          children: <Widget>[
            FutureBuilder<ImageProvider>(
              future: Future.value(const AssetImage('backend/display.png')), // Replace with your image path and name
